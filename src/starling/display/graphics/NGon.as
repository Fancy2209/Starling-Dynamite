...
package starling.display.graphics
{
	...
	public class NGon extends GraphicRenderer
	{
		...
		private static function buildSimpleNGon(radius:Number,
												numSides:int,
												...
												color:uint):void
		{
			...
			if(uvMatrix)
			{
				MatrixUtil.transformPoint(uvMatrix, _uv, _uv);
			}
			...
			// avoiding push because of memory allocation
			vertices[len] = 0;
			vertices[++len] = 0;
			vertices[++len] = 0;
			vertices[++len] = r;
			...
			anglePerSide = (Math.PI * 2) / numSides;
		...
		{
			nv = 0;
			radiansPerDivision = (Math.PI * 2) / numSides;
			startRadians = (startAngle / radiansPerDivision);
